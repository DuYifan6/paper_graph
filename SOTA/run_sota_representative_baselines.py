...
def run(cfg: Config) -> None:
    ...
    # Run ZeroGraph-style LSTM first if requested or needed as baseline.
    # In your paper, ZeroGraph is the no-graph LSTM. For SOTA DM, use this as base.
    if "lstm" not in requested:
        requested_for_base = ["lstm"] + requested
    else:
